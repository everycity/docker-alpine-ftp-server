...
This repo was forked from https://www.github.com/delfer/docker-alpine-ftp-server and modified to remove the xfs user so UID/GID 33 could be used for ftp users (www-data on Debian systems).
